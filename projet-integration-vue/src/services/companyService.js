...
const getUnconfirmedCompanies = async () => {
  try {
    const response = await axiosInstance.get(
      "api/companies/getUnconfirmedCompanies"
    );
    return response.data;
  } catch (error) {
...
const getConfirmedCompanies = async () => {
  try {
    const response = await axiosInstance.get(
      "api/companies/getConfirmedCompanies"
    );
    return response.data;
  } catch (error) {
...
const confirmCompany = async (id) => {
  try {
    const response = await axiosInstance.put(
      `api/companies/confirmCompany/${id}`
    );
    return response.data;
  } catch (error) {
...
const unconfirmCompany = async (id) => {
  try {
    const response = await axiosInstance.put(
      `api/companies/unconfirmCompany/${id}`
    );
    return response.data;
  } catch (error) {
...
const fetchMyCompanyEvents = async () => {
  try {
    const response = await axiosInstance.get("api/events/companies/2/events");
    return response.data;
  } catch (error) {
