  ...
  <nav class="navbar">
    <div class="container">
      <div class="brand-section">
        ...
        <span class="brand-name">Company Portal</span>
      </div>
      ...
      <div class="user-section">
        ...
        <div class="user-info">
          <span class="user-name">{{ currentUser.name || 'Company User' }}</span>
  ...
  methods: {
    ...
    loadCurrentUserData() {
      ...
      if (token) {
        ...
        if (decoded) {
          this.currentUser.name = decoded.name || decoded.username || decoded.sub || 'Company';
        }
      }
    }
  },
